...
function ENT:Initialize()
	self.Entity:SetModel( "models/props/prop_damselfish.mdl" )
...
function ENT:Use( activator, caller )
	...
	activator:PrintMessage( HUD_PRINTTALK, "Ye Caught a Damsel Fish!" )
	...
	activator:GiveItem( "fish_damsel", 1 )
	self:Remove()
	ShowTipPlayer(activator, 0, 4, "Picked up a Damsel Fish." )

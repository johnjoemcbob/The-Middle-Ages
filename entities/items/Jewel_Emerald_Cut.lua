...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local CutEmerald = ents.Create( "resource_emerald" )
		CutEmerald:SetModel( "models/Gibs/Shield_Scanner_Gib1.mdl" )
		CutEmerald:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		CutEmerald:Spawn( )
		CutEmerald:Activate( )
	end

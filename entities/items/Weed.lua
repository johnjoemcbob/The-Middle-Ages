...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Weed = ents.Create( "resource_weed" )
		Weed:SetModel( "models/props/de_inferno/fountain_bowl_p8.mdl" )
		Weed:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		Weed:Spawn( )
		Weed:Activate( )
	end

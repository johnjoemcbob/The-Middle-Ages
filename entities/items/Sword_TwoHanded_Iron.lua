...
ITEM.UniqueID = "sword_twohanded_iron"
...
ITEM.Name = "Iron Two-Handed Sword"

ITEM.Price = 140
local price = 140

-- The description for this item, used in the inventory menu.
ITEM.Description = "A Two-Handed Iron Sword"
...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Aria = ents.Create( "ent_sword_twohanded_iron" )

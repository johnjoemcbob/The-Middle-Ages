...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Copper = ents.Create( "resource_copper" )
		Copper:SetModel( "models/props_junk/Rock001a.mdl" )
		Copper:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		Copper:Spawn( )
		Copper:Activate( )
	end

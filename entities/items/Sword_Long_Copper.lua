...
ITEM.UniqueID = "sword_long_copper"
...
ITEM.Name = "Copper Long Sword"

ITEM.Price = 40
local price = 40

-- The description for this item, used in the inventory menu.
ITEM.Description = "A Long Copper Sword"
...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Aria = ents.Create( "ent_sword_long_copper" )

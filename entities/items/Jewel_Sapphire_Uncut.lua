...
ITEM.Description = "Uncut Sapphire"
...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local UncutSapphire = ents.Create( "resource_sapphire_uncut" )
		UncutSapphire:SetModel( "models/props_junk/Rock001a.mdl" )
		UncutSapphire:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		UncutSapphire:Spawn( )
		UncutSapphire:Activate( )
	end

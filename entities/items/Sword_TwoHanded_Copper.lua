...
ITEM.UniqueID = "sword_twohanded_copper"
...
ITEM.Name = "Copper Two-Handed Sword"

ITEM.Price = 120
local price = 120

-- The description for this item, used in the inventory menu.
ITEM.Description = "A Two-Handed Copper Sword"
...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Aria = ents.Create( "ent_sword_twohanded_copper" )
	...
	function ITEM:EQUIP( ply )
		ply:Give("sword_twohanded_copper")
	end
end

...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local Poison = ents.Create( "Poison" )
		Poison:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		Poison:Spawn( )
		Poison:Activate( )
	end
	...
	function ITEM:DRINK( ply )
		...
		ply:SetHealth(hp)
		ply:PrintMessage(HUD_PRINTTALK, "You poisoned yourself.")
	end

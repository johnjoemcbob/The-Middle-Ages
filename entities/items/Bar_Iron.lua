...
if ( SERVER ) then -- Only used on server so use this check.
	function ITEM:USE( ply )
		...
		local IronBar = ents.Create( "bar_iron" )
		IronBar:SetModel( "models/nayrbarr/iron/iron.mdl" )
		IronBar:SetPos( Vector( tr.HitPos.x, tr.HitPos.y, tr.HitPos.z + 16 ) )
		IronBar:Spawn( )
		IronBar:Activate( )
	end

...
if ( CLIENT ) then
	SWEP.PrintName		= "Fine Dwarven Sword"
	SWEP.Purpose        = "A Dwarven Sword made specialy for the Ruler of the Dwarven Empire."
	SWEP.Instructions   = "Primary to strike."
end
-------------------------------------------------------------------
SWEP.Base 				= "medieval_weapon_base"
----------------------------------------------------
SWEP.ViewModel			= "models/WorldofWarcraft/2H_Swords/broadsword_sword_2h_06.mdl"

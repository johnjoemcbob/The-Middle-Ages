...
if ( CLIENT ) then
	SWEP.PrintName		= "Dwarven Mini Projectile Launcher"
	SWEP.Purpose        = "Gifted to the Dwarves by the fine Engineers of the Gnomish Empire."
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:ShootBullets( math.random( 20, 30 ) )
